...
# делать "в собственности:"
# автозапуск базы через bash
# ui сделать
# сделать возможность массвого заполнения
# доработка bash и requirements
# когда не удалось, пробовать по новой заполнять поля 
# автопоиск по фио матери 
# когда заполнили и сделали скрин переходим обратно на страницу поиска
