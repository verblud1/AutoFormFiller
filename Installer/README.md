...
Папка `registry` содержит исходные файлы реестров, используемые системой для обработки семей. Эти файлы копируются в установленную систему для обеспечения функциональности обработки реестров.

Файл `autosave_families.json` содержит автосохраненные данные семей для восстановления при необходимости.